...
module.exports = {
  async up (queryInterface, Sequelize) { // aqui estamos criando uma nova coluna com relacionamento com outra tabela
    await queryInterface.addColumn('classes', 'course_id', { // pra adicionar a coluna, colocamos o addColumn; 1a parâmetro é a tabela que vc vai adicionar a coluna
  ...
  async down (queryInterface, Sequelize) {
    await queryInterface.removeColumn('classes', 'course_id')
